  ...
  return (
    ...
    >
      ...
      <div
        ...
        className={cn(
          "fixed top-[var(--header-height,0px)] z-10 hidden h-[calc(100svh-var(--header-height,0px))] w-(--sidebar-width) transition-[inset-inline-start,inset-inline-end,width] duration-200 ease-linear md:flex",
          side === "left"
